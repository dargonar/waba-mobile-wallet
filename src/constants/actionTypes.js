...
export const NEW_TX_ACTION          	= 'NEW_TX_ACTION';
export const BUSINESS_FILTER_SUCCESS  = 'BUSINESS_FILTER_SUCCESS'; 
export const RETRIEVE_BUSINESS_LIST_SUCCESS = 'RETRIEVE_BUSINESS_LIST_SUCCESS';
export const RETRIEVE_BUSINESS_LIST_ERROR 	= 'RETRIEVE_BUSINESS_LIST_ERROR';
export const RETRIEVE_BUSINESS_SEARCH_SUCCESS = 'RETRIEVE_BUSINESS_SEARCH_SUCCESS';
export const RETRIEVE_BUSINESS_SEARCH_ERROR 	= 'RETRIEVE_BUSINESS_SEARCH_ERROR';
