  ...
  _renderRow(rowData, sectionID, rowID) {
    ...
    if(rowData.__typename == 'WithdrawPermission' && this.state.is_subaccount) {
      ...
      return(
       ...
       let rotato = {received:'0 deg', sent : '-180 deg', refunded_subacc:'-180 deg', discounted_subacc:'0 deg', refunded:'0 deg'     , discounted:'-180 deg'};
       //let bg     = {received:'#8ec919', sent:'#fcc4cb'};
	   //let bg     = {received:'#A2EA4A', sent:'#FF7251'};
	   let bg     = {received:'#76eafa', sent:'#f576ff', refunded_subacc:'#ff73b9', discounted_subacc:'#80fbbf', refunded:'#80fbbf', discounted:'#ff73b9'};
