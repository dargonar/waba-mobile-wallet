...
class RewardConfirm extends Component {
  ...
  _getTx() {
	...
	_buildMemo() {
		return new Promise( (resolve, reject) => {
      let memo = config.REFUND_PREFIX+':'+this.state.bill_amount +':NA:'+ qr_helper.getCleanName(this.props.account.subaccount.business.name);
  ...
  componentDidMount() {
    ...
    this.setState({ identicon : identicon });
  	let that = this;
    setTimeout( function() { that._getTx();}
  							, 300);
  }
  ...
  render() {
    ...
    let imgData = 'data:image/png;base64,';
  	let total 	= this.state.reward_dsc; //this.getTotal();
		//let fee = this.state.fee_txt.toFixed(this.props.asset.precision);
		let fee 		= Number(this.state.fee)/Math.pow(10,config.ASSET_PRECISION).toFixed(config.ASSET_PRECISION);
        ...
        <ScrollView contentContainerStyle={{ flexDirection:'column', padding:20, paddingTop: 0}}>
          ...
          <View style={styles.detailsView2}>
            ...
            <View flexDirection='column' style={{marginBottom:10}}>
              ...
              <Text style={styles.text}>{_bill_id}</Text>
            </View>

            <View flexDirection='column' style={{marginBottom:10}}>
              <Text style={styles.label}>Descuento:</Text>
              <Text style={styles.text}>{this.state.reward_rate}{"%"}</Text>
            </View>
          </View>
