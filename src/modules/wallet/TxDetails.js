...
class TxDetails extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      bill_amount   : 0,
      bill_id       : '',
      processedData : this.processData(props.rowData, props.memo, props.account_name)

    }

  }
  
  processData(rowData, memo, account_name){
  ...
  componentDidMount() {
    // En teoria este check no es necesario
  ...
  render() {
    ...
    let imgData = 'data:image/png;base64,';
  	let fromIcon = (<Image style={{width: 40, height: 40, resizeMode: Image.resizeMode.contain, borderWidth: 0}} source={{uri: config.getIdenticon(this.state.from.name)}}/>)
    let toIcon = (<Image style={{width: 40, height: 40, resizeMode: Image.resizeMode.contain, borderWidth: 0}} source={{uri: config.getIdenticon(this.state.to.name)}}/>)
      ...
      <View style={styles.container}>
        <ScrollView contentContainerStyle={{ flexDirection:'column', padding:20, paddingTop: 0}}>
          ...
          { (this.state.processedData && !this.state.processedData._is_simple)?
            ...
            (
              <View style={styles.detailsView}>
                <View style={styles.billAmount}>
                  ...
                  <Text style={styles.labelTitle}>{"$"}{this.state.processedData._bill_amount}</Text>
                </View>
        
                <View flexDirection='column' style={{marginBottom:10}}>
                  <Text style={styles.label}>Fecha:</Text>
                  <Text style={styles.text}>{this.state.processedData._fecha} {this.state.processedData._hora}</Text>
                </View>

                <View flexDirection='column' style={{marginBottom:10}}>
                  <Text style={styles.label}>NroFactura/recibo/referencia:</Text>
                  <Text style={styles.text}>{this.state.processedData._bill_id}</Text>
                </View>

                {/*
                  <View flexDirection='column' style={{marginBottom:10}}>
                                  <Text style={styles.label}>Memo:</Text>
                                  <Text style={styles.text}>{this.state.processedData._message}</Text>
                                </View>
                */}

                <View flexDirection='column' style={{marginBottom:10}}>
                  <Text style={styles.label}>Descuento:</Text>
                  <Text style={styles.text}>{this.state.processedData._discount*100}{"%"}</Text>
                </View>
              </View>
            )
