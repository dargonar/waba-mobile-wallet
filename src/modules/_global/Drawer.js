...
// 						</TouchableOpacity>
		...
		// const iconEndorsement = (<Icon name="md-ribbon" size={26} color="#B7F072" style={[styles.drawerListIcon, { paddingLeft: 2 }]} />);
 		const iconEndorsement = (<Icon name="md-thumbs-up" size={26} color="#ffffff" style={[styles.drawerListIcon, { paddingLeft: 2 }]} />);
		...
		return (
				...
				<View style={styles.container}>
					...
					<TouchableOpacity onPress={this._onGoToWABA}>
						<View style={styles.drawerListItem2}>
							<Text style={styles._version}>
								DisCoin Alpha version{"\n"}powered by WABA.network
							</Text>
						</View>
					</TouchableOpacity>
				</View>
