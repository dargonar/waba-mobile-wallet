...
class SwitchConfirm extends Component {
  ...
  render() {
    ...
    let send_disabled = !this.state.can_confirm;
		...
		let button_text = 'CONFIRMAR CAMBIO';
    ...
    return (
      <View style={styles.container}>
        <View style={{flex:5, backgroundColor:'#ffffff', paddingTop:10, paddingRight:0, paddingBottom:30}}>
          <View>
            <Text style={styles.title_part_big}>{title_text}</Text>
          </View>
          <View style={{margin:20}}>
            <Text style={styles.label}>COMERCIO:</Text>
            <View style={styles.data_partView}>
              ...
              <View flexDirection='row' alignItems='center' style={{marginTop:10,}}>
                ...
                <Text style={styles.data_part_small}>{this.state.business.account}</Text>
              </View>
            </View>
          </View>
          <View style={{margin:20, marginTop:0}}>
            <Text style={styles.label}>MONTO DIARIO:</Text>
            <View flexDirection='row' alignItems='center' justifyContent='center' style={{borderWidth:0.5, borderColor:'#ccc', borderRadius: 15, marginTop: 10}}>
              <Image style={{width: 15, height: 15, resizeMode: Image.resizeMode.contain, opacity: 0.7, borderWidth: 0, marginRight: 5}} source={{uri: imgData}}/>
              <Text style={styles.data_dayAmount}>{total}</Text>
